...
export const USDC_MAINNET = new Token(SupportedChainId.MAINNET, "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", 6, "USDC", "USD//C");
export const USDC_ROPSTEN = new Token(SupportedChainId.ROPSTEN, "0x07865c6e87b9f70255377e024ace6630c1eaa37f", 6, "USDC", "USD//C");
export const USDC_RINKEBY = new Token(SupportedChainId.RINKEBY, "0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b", 6, "tUSDC", "test USD//C");
export const USDC_GOERLI = new Token(SupportedChainId.GOERLI, "0x07865c6e87b9f70255377e024ace6630c1eaa37f", 6, "USDC", "USD//C");
export const USDC_KOVAN = new Token(SupportedChainId.KOVAN, "0x31eeb2d0f9b6fd8642914ab10f4dd473677d80df", 6, "USDC", "USD//C");
export const USDC_OPTIMISM = new Token(SupportedChainId.OPTIMISM, "0x7F5c764cBc14f9669B88837ca1490cCa17c31607", 6, "USDC", "USD//C");
export const USDC_OPTIMISTIC_KOVAN = new Token(SupportedChainId.OPTIMISTIC_KOVAN, "0x3b8e53b3ab8e01fb57d0c9e893bc4d655aa67d84", 6, "USDC", "USD//C");
...
export const USDC_ARBITRUM_RINKEBY = new Token(SupportedChainId.ARBITRUM_RINKEBY, "0x09b98f8b2395d076514037ff7d39a091a536206c", 6, "USDC", "USD//C");
export const USDC_POLYGON = new Token(SupportedChainId.POLYGON, "0x2791bca1f2de4661ed88a30c99a7a9449aa84174", 6, "USDC", "USD//C");
export const USDC_POLYGON_MUMBAI = new Token(SupportedChainId.POLYGON_MUMBAI, "0xe11a86849d99f524cac3e7a0ec1241828e332c62", 6, "USDC", "USD//C");
export const USDC_BINANCE = new Token(SupportedChainId.BSC, "0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d", 18, "USDC", "USD//C");
export const USDC_BINANCE_TESTNET = new Token(SupportedChainId.BSC_TESTNET, "0x64544969ed7EBf5f083679233325356EbE738930", 18, "USDC", "USD//C");
export const PORTAL_USDC_CELO = new Token(SupportedChainId.CELO, "0x37f750B7cC259A2f741AF45294f6a16572CF5cAd", 6, "USDCet", "USDC (Portal from Ethereum)");
export const USDC_CELO_ALFAJORES = new Token(SupportedChainId.CELO_ALFAJORES, "0x41F4a5d2632b019Ae6CE9625bE3c9CaC143AcC7D", 6, "USDC", "USD//C");
...
export const USDC: { [chainId in SupportedChainId]: Token } = {
  ...
  [SupportedChainId.BSC]: USDC_BINANCE,
  [SupportedChainId.BSC_TESTNET]: USDC_BINANCE_TESTNET,
};
...
export const WETH_GOERLI = new Token(SupportedChainId.GOERLI, "0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6", 18, "WETH", "Wrapped Ether (Goerli)");
...
export const CELO_CELO = new Token(SupportedChainId.CELO, "0x471EcE3750Da237f93B8E339c536989b8978a438", 18, "CELO", "Celo");
export const CUSD_CELO = new Token(SupportedChainId.CELO, "0x765DE816845861e75A25fCA122bb6898B8B1282a", 18, "cUSD", "Celo Dollar");
export const CEUR_CELO = new Token(SupportedChainId.CELO, "0xD8763CBa276a3738E6DE85b4b3bF5FDed6D6cA73", 18, "cEUR", "Celo Euro Stablecoin");
export const PORTAL_ETH_CELO = new Token(SupportedChainId.CELO, "0x66803FB87aBd4aaC3cbB3fAd7C3aa01f6F3FB207", 18, "ETH", "Portal Ether");
export const CMC02_CELO = new Token(SupportedChainId.CELO, "0x32A9FE697a32135BFd313a6Ac28792DaE4D9979d", 18, "cMCO2", "Celo Moss Carbon Credit");
...
export const BUSD_MAINNET = new Token(SupportedChainId.BSC, "0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56", 18, "BUSD", "Binance-Peg BUSD Token");
export const BUSD_TESTNET = new Token(SupportedChainId.BSC_TESTNET, "0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee", 18, "BUSD", "Binance USD");

export const BUSD: { [chainId in SupportedChainId]: Token } = {
  [SupportedChainId.MAINNET]: BUSD_TESTNET,
  [SupportedChainId.ARBITRUM_ONE]: BUSD_TESTNET,
  [SupportedChainId.OPTIMISM]: BUSD_TESTNET,
  [SupportedChainId.ARBITRUM_RINKEBY]: BUSD_TESTNET,
  [SupportedChainId.OPTIMISTIC_KOVAN]: BUSD_TESTNET,
  [SupportedChainId.POLYGON]: BUSD_TESTNET,
  [SupportedChainId.POLYGON_MUMBAI]: BUSD_TESTNET,
  [SupportedChainId.CELO]: BUSD_TESTNET,
  [SupportedChainId.CELO_ALFAJORES]: BUSD_TESTNET,
  [SupportedChainId.GOERLI]: BUSD_TESTNET,
  [SupportedChainId.RINKEBY]: BUSD_TESTNET,
  [SupportedChainId.KOVAN]: BUSD_TESTNET,
  [SupportedChainId.ROPSTEN]: BUSD_TESTNET,
  [SupportedChainId.BSC]: BUSD_MAINNET,
  [SupportedChainId.BSC_TESTNET]: BUSD_TESTNET,
};
